import{_ as M}from"./Cly01Tha.js";import{j as h,A as x,B as v,i as y,v as b,C as f,o as n,c as p,a as s,t as _,l as J,n as j,u as t,D as W,h as B,F as k,r as l,g as u,w as g,d as H}from"./DDV8MkC4.js";const S=["id"],$={class:"text-center text-xl font-semibold"},C={class:"p-2"},P=h({__name:"expandable",props:{title:{},id:{},open:{type:Boolean}},setup(m){let i=m,e=x({open:i.open,contentHeight:0});const a=v();function c(){e.open=!e.open,e.open&&a.push({hash:`#${i.id}`})}const r=y(null);return b(()=>{var o,z;console.log("elo"),e.contentHeight=((o=r.value)==null?void 0:o.scrollHeight)||0,console.log((z=r.value)==null?void 0:z.scrollHeight)}),f(()=>i.open,o=>{e.open=o}),(o,z)=>(n(),p("div",{onClick:c,class:j("flex flex-col -scroll-mt-30 overflow-hidden p-6 rounded-md group hover:bg-slate-100"+(t(e).open,"")),id:o.id},[s("div",$,_(o.title),1),s("div",{class:j("overflow-hidden duration-300 "+(t(e).open?"":"!max-h-0")),ref_key:"content",ref:r,style:W(`max-height: ${t(e).contentHeight||1e3}px`)},[s("div",C,[J(o.$slots,"default")])],6)],10,S))}}),T={class:"flex flex-col md:flex-row md:px-30 space-x-6 mt-10"},L={class:"hidden md:sticky md:top-20 md:flex flex-col space-y-2 self-start"},N={class:"flex flex-col space-y-1"},D=["innerHTML"],A=h({__name:"mediacje",setup(m){let i=[{title:"Czym jest mediacja",content:`
    <p>
...
`},{title:"Mediacje pracownicze",content:`
        ...
        `}];y();let e=B(),a=y();return b(()=>{console.log(e.hash),e.hash?a.value=e.hash:a.value="#0"}),f(e,async(c,r)=>{a.value=c.hash||"#0",console.log(a.value)}),(c,r)=>{const o=M,z=P;return n(),p("div",T,[s("div",L,[(n(!0),p(k,null,l(t(i),(d,w)=>(n(),u(o,{class:"p-2 rounded-md hover:bg-slate-100 w-55 text-center",href:`#${w}`},{default:g(()=>[H(_(d.title),1)]),_:2},1032,["href"]))),256))]),s("div",N,[(n(!0),p(k,null,l(t(i),(d,w)=>(n(),u(z,{title:d.title,id:w.toString(),open:`#${w.toString()}`==t(a)},{default:g(()=>[s("div",{innerHTML:d.content},null,8,D)]),_:2},1032,["title","id","open"]))),256))])])}}});export{A as default};
