import{R as l,G as c,a5 as g,o as b,I as h,a6 as a,ao as s,ap as t,F as d,au as p,L as z,a7 as y,a8 as m,av as f,at as _,aq as M}from"./app.config.87378446.js";import{_ as x}from"./expandable.vue.670a64c3.js";const J={class:"flex space-x-6 mt-10"},W={class:"sticky top-20 flex flex-col space-y-2 self-start"},v={class:"flex flex-col space-y-1"},B=["innerHTML"],C=l({__name:"mediacje",setup(P){let r=[{title:"Czym jest mediacja",content:`
    <p>
...
`},{title:"Mediacje pracownicze",content:`
        ...
        `}];c();let o=g(),e=c();return b(()=>{console.log(o.hash),o.hash?e.value=o.hash:e.value="#0"}),h(o,async(w,j)=>{e.value=w.hash||"#0",console.log(e.value)}),(w,j)=>{const k=M,u=x;return a(),s("div",J,[t("div",W,[(a(!0),s(d,null,p(z(r),(i,n)=>(a(),y(k,{class:"p-2 rounded-md hover:bg-slate-100 w-55 text-center",href:`#${n}`},{default:m(()=>[f(_(i.title),1)]),_:2},1032,["href"]))),256))]),t("div",v,[(a(!0),s(d,null,p(z(r),(i,n)=>(a(),y(u,{title:i.title,id:n.toString(),open:`#${n.toString()}`==z(e)},{default:m(()=>[t("div",{innerHTML:i.content},null,8,B)]),_:2},1032,["title","id","open"]))),256))])])}}});export{C as default};
