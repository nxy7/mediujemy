import{W as l,K as c,aB as g,o as b,M as h,a5 as a,a6 as s,a7 as t,F as d,al as p,ag as y,ad as m,ap as f,ao as M,P as z,aM as _}from"./app.config.edc666ea.js";import{_ as x}from"./expandable.vue.b551f840.js";const J={class:"flex space-x-6 mt-10 px-30"},W={class:"sticky top-20 flex flex-col space-y-2 self-start"},v={class:"flex flex-col space-y-1"},B=["innerHTML"],L=l({__name:"mediacje",setup(P){let r=[{title:"Czym jest mediacja",content:`
    <p>
...
`},{title:"Mediacje pracownicze",content:`
        ...
        `}];c();let o=g(),e=c();return b(()=>{console.log(o.hash),o.hash?e.value=o.hash:e.value="#0"}),h(o,async(w,j)=>{e.value=w.hash||"#0",console.log(e.value)}),(w,j)=>{const k=_,u=x;return a(),s("div",J,[t("div",W,[(a(!0),s(d,null,p(z(r),(i,n)=>(a(),y(k,{class:"p-2 rounded-md hover:bg-slate-100 w-55 text-center",href:`#${n}`},{default:m(()=>[f(M(i.title),1)]),_:2},1032,["href"]))),256))]),t("div",v,[(a(!0),s(d,null,p(z(r),(i,n)=>(a(),y(u,{title:i.title,id:n.toString(),open:`#${n.toString()}`==z(e)},{default:m(()=>[t("div",{innerHTML:i.content},null,8,B)]),_:2},1032,["title","id","open"]))),256))])])}}});export{L as default};
