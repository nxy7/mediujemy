<template>
    ...
    <div class="mt-8 flex flex-col space-y-1">
        <Expandable title="Czym jest mediacja">
            <p>
        ...
        <Expandable title="Mediacje sądowe i pozasądowe">
        ...
        <Expandable title="Mediacje cywilne">
        ...
        <Expandable title="Mediacje rodzinne i okołorozwodowe">
        ...
        <Expandable title="Mediacje gospodarcze">
        ...
        <Expandable title="Mediacje karne"></Expandable>
        <Expandable title="Mediacje pracownicze">
        ...
        <Expandable title="Wybór mediatora i przebieg mediacji">
        ...
        <Expandable title="Mediacja online">
